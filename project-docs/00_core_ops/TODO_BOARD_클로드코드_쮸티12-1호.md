...
| W-038 | P1 | T-038 | **코딩완료(TEST WAIT)** | **[문서 정리] project-docs 폴더 구조 변경 git 반영** | `project-docs/120_plan/` (신규), `project-docs/00_plan/` (삭제), `2026-07/PLAN_7월_썸머베케이션대출_기획서.md` (삭제→120_plan) | 사장님 직접 이동 완료: ①00_plan 전체→120_plan ②2026-07 기획서→120_plan ③루트 PLAN_홈페이지_7월전환 삭제 / git 반영 + 커밋 ✅ WT-048 | 2026-07-01 | 쮸티12-1호 |

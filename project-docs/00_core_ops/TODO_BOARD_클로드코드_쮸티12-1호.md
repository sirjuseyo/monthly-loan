...
| W-042 | P0 | T-030~T-039 (PRD) | **진행중** | **[7월 썸머 베케이션] PRD 파일 생성/업데이트 — T-030~T-039 반영** | `index.html` (루트), `2026-07/index.html` (신규) | ①루트 index.html: T-036(7월 전환 본문+팝업 이벤트 활용%), T-037(checker-card 숨김), T-039(서핑 이미지) 반영 ②2026-07/index.html 신규 생성: index-dev.html 기반 DEV 배너 제거 + href apply.html 변경 | 2026-07-02 | 쮸티12-1호 |

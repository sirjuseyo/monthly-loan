...
| W-037 | P0 | - | **대기** | **[홈 페이지] index-dev.html 대출 가능성 검사기 카드 숨김** | `index-dev.html`, `PLAN_홈페이지_7월전환_기획서.md` | checker-card 블록 `display:none` 숨김 처리 / 기획서 v0.3 반영 완료 | 2026-07-01 | 쮸티12-1호 |

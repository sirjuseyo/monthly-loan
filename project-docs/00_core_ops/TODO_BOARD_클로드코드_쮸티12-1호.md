...
| W-040 | P0 | T-040 | **코딩완료(TEST WAIT)** | **[6월 페이지] 마감 처리 — 기존 내용 숨김 + 마감 문구 표시** | `2026-06/index-dev.html` | `<body>` 직후 마감 문구 div 삽입 / 기존 전체 내용 `display:none` 감싸기 (HTML 주석 중첩 이슈 대응) / 커밋 ✅ WT-050 | 2026-07-02 | 쮸티12-1호 |

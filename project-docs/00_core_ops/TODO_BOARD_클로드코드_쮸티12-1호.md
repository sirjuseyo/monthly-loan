...
| **T-002** | WT-002 | W-002 | `c21ccdd` | **진행중(In-Progress)** | **6월 대출 페이지 PC 좌우 너비 480px 고정** | 쮸티12-1호 | 2026-06-18 23:30 | 【파일】`2026-06/index.html`, `2026-06/index-dev.html` / `.wrap { max-width:480px; margin:0 auto; }` CSS 추가 |

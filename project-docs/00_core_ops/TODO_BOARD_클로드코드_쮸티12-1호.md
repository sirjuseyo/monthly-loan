...
| W-036 | P0 | - | **대기** | **[홈 페이지] index-dev.html 7월 전환** | `index-dev.html`, `PLAN_홈페이지_7월전환_기획서.md` | 본문: ①live-badge 6월→7월 ②gift-box 7월 이미지 ③이달의 대출 제목/링크 7월 전환 ④월드컵 카드 삭제 또는 7월 이벤트 카드 교체 / 팝업: ⑤이벤트 활용 포인트 7월 기준으로 변경 / 기획서 `PLAN_홈페이지_7월전환_기획서.md` v0.1 작성 완료 | 2026-07-01 | 쮸티12-1호 |

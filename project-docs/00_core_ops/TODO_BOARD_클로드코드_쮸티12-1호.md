...
| W-034 | P0 | - | **대기** | **[7월 기획서 + index-dev.html] 🔍 비교하세요. 섹션 이벤트 대출 이포→원리포 + 원금 미션 재계산** | `2026-07/index-dev.html`, `2026-07/PLAN_7월_썸머베케이션대출_기획서.md` | 비교 테이블 10만~50만 이벤트 대출 행: ①상환 방식 이포→원리포 ②원금 미션 감면→포인트(1%) ③합계 재계산(10만 6,500 / 20만 8,500 / 30만 10,500 / 50만 14,500포) / 기획서 v0.7 반영 완료 | 2026-07-01 | 쮸티12-1호 |

...
| W-041 | P0 | T-041 | **진행중** | **[6월 PRD] index.html 마감 처리 — DEV와 동일 적용** | `2026-06/index.html` | T-040 누락 보완 — DEV(`index-dev.html`)만 수정했으나 PRD(`index.html`) 미반영 / 동일 마감 처리 적용 | 2026-07-02 | 쮸티12-1호 |

...
| T-015 | 월드컵 카드 → 예언 챌린지 기획서·와이어프레임 수정 | 완료 | 대기 | - | - | - | 쮸티12호 | 2026-06-02 | 문서전용(Untracked) |
| T-016 | 월드컵 카드 → 예언 챌린지 코드 반영 (DEV/PRD) | 완료 | 대기 | 미반영 | - | - | 쮸티12호 | 2026-06-02 | `index.html`+`index-dev.html` |
| T-017 | gift-box 모바일 텍스트 침범 보정 | 완료 | 대기 | 미반영 | - | - | 쮸티12호 | 2026-06-02 | 모바일 ≤767px 한정 |
...
| **T-015** | WT-016 | W-015 | `문서전용` | **테스트 완료(DONE)** | **월드컵 카드 → 예언 챌린지 기획서·와이어프레임 수정** | 쮸티12호 | 2026-06-02 | 【파일】`wireframe-...-jun-v2.html` / `PLAN_2026-06_...기획서.md` (Untracked) |
| **T-016** | WT-017 | W-016 | `2e2bf3b` | **테스트 완료(DONE)** | **월드컵 카드 → 예언 챌린지 코드 반영 (DEV/PRD)** | 쮸티12호 | 2026-06-02 | 【파일】`index.html` + `index-dev.html` / 버튼 🐙 승무패 예언하기 |
| **T-017** | WT-018 | W-017 | `0a81b5c` | **테스트 완료(DONE)** | **gift-box 모바일 텍스트 침범 보정 (미디어쿼리)** | 쮸티12호 | 2026-06-02 | 【파일】`index.html` + `index-dev.html` / 모바일 ≤767px 한정 |
